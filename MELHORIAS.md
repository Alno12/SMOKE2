...
### 1.1 Atalho do PWA não funciona — ALTA
...
### 1.3 Gravação pode ser descartada em condição de corrida — ALTA
...
### 1.4 `beforeunload` sempre exibe diálogo de confirmação — MÉDIA
...
### 1.8 Contador "hoje" conta registros futuros — BAIXA
...
### 1.9 Eixo do hazard não bate com os dados — BAIXA
...
### 1.11 Assets do SW incompletos — BAIXA
...
### 2.1 Significância da ANOVA com limiar fixo
...
### 2.2 IC 95% da média com z em vez de t
